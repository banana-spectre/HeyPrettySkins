                ...
                <table class="names">
                    <tr>
                        ...
                        <td><label for="type"><b>Type</b></label> <br>
                            <select type="text" name="type" id="type" class="form-control" placeholder="Type" required>
                                <option value="in">In</option>
                                <option value="out">Out</option>
                            </select><br>
                        </td>

                        <td class="in-out-quantity"><label for="in_qty"><b>Quantity</b></label> <br> <input type="number" name="qty" id="qty" class="form-control" required></td>      
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>&emsp;</td>
                        <td><label for="best_before"><b>Best Before</b></label> <br> <input type="date" name="best_before" id="best_before" class="form-control" required> </td> 
